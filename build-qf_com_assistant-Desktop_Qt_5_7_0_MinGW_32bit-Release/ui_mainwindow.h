...
public:
    ...
    QPushButton *pushButton_updateSystem;
    QWidget *tab_9;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_format->setGeometry(QRect(20, 70, 101, 31));
        pushButton_loadDef = new QPushButton(tab_3);
        pushButton_loadDef->setObjectName(QStringLiteral("pushButton_loadDef"));
        pushButton_loadDef->setGeometry(QRect(130, 70, 91, 31));
        pushButton_updateSystem = new QPushButton(tab_3);
        pushButton_updateSystem->setObjectName(QStringLiteral("pushButton_updateSystem"));
        pushButton_updateSystem->setGeometry(QRect(230, 10, 91, 91));
        ...
        pushButton_updateTime->setGeometry(QRect(10, 80, 171, 23));
        ...
        pushButton_stopRec_byMcu->setGeometry(QRect(330, 20, 81, 23));
        ...
        pushButton_startRec_byMcu->setGeometry(QRect(330, 50, 81, 23));
        pushButton_accOff = new QPushButton(tab_9);
        pushButton_accOff->setObjectName(QStringLiteral("pushButton_accOff"));
        pushButton_accOff->setGeometry(QRect(100, 50, 81, 23));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_updateSystem->setText(QApplication::translate("MainWindow", "update", 0));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("MainWindow", "reserve", 0));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("MainWindow", "reserve", 0));
